...
def create_model():
	model = Sequential()
	model.add(layers.TimeDistributed(layers.TimeDistributed(layers.Conv1D(128, 3, activation='tanh')), input_shape=(TIME_STEP, WINDOW_SIZE, 7, 1)))
	model.add(layers.TimeDistributed(layers.TimeDistributed(layers.Conv1D(256, 3, activation='tanh'))))
	model.add(layers.TimeDistributed(layers.TimeDistributed(layers.Flatten())))
	model.add(layers.TimeDistributed(layers.LSTM(64, dropout=0.5)))
