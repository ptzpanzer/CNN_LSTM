...
test_file_list  = vec_list[(int)(0.9*len(vec_list)) : (int)(1.0*len(vec_list))]
valid_file_list = vec_list[(int)(0.9*len(vec_list)) : (int)(1.0*len(vec_list))]
train_file_list = vec_list[(int)(0.0*len(vec_list)) : (int)(0.9*len(vec_list))] #+ vec_list[(int)(0.9*len(vec_list)) : (int)(1.0*len(vec_list))]
...
with open('Output9.txt', 'w', encoding='UTF-8') as f:
